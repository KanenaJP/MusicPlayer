...
namespace MusicPlayer.MVVM.Model
{
    ...
    class PlayerModel : BindableBase
    {
        ...
        private PlayListCollection ShuffledList;
        private DispatcherTimer timer;

        public PlayerModel(PlayListCollection playList)
        {
            ...
            PlayPauseCommand = new DelegateCommand(() => PlayPause()); //, () => canPause.HasFlag(MediaState)
        ...
        {
            if (IsShuffle)
                ShuffledList = new PlayListCollection(playList.OrderBy(i => Guid.NewGuid()).ToList());
        }
